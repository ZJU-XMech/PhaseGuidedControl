...
void MP_Controller::initializeController() {
...
void MP_Controller::readGamepadCommand1()
{
...
void MP_Controller::readRCCommand1()
{
...
void MP_Controller::readGamepadCommand2()
{
    change_gait = false;
    ...
    {
        gait_idx = gait_idx > 7 ? 0 : gait_idx + 1;
        change_gait = true;
    ...
    // other options
    // second_level_kp = std::fabs(_driverCommand->rightStickAnalog[1]) > 0.3 ? _driverCommand->rightStickAnalog[1]*0.12 : 0.0;

    // set gait
    // cpg.change_gait(gait_idx);
}

void MP_Controller::readRCCommand2()
{
    change_gait = false;
...
void MP_Controller::runController() {
...
void MP_Controller::updateVisualization() {
