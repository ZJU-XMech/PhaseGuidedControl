#ifndef BLACKPANTHER_CPG_CONTROLLER_HPP
#define BLACKPANTHER_CPG_CONTROLLER_HPP

#include <RobotController.h>
#include "CPG_UserParameters.h"
#include "NN_IO_t.hpp"
...
class CPG_Controller : public RobotController {
public:
    CPG_Controller() : RobotController(), _dt(0.001), _lcm(getLcmUrl(255)) {
        memset(&nn_data_lcm, 0, sizeof(NN_IO_t));
    }

    ~CPG_Controller() override = default;  // delete function
...
private:
    ...
    CPG_UserParameters userParameters;  // config parameter
...
#endif //BLACKPANTHER_CPG_CONTROLLER_HPP
