...
#ifndef BLACKPANTHER_CPG_USERPARAMETERS_H
#define BLACKPANTHER_CPG_USERPARAMETERS_H

#include "ControlParameters/ControlParameters.h"
#define Ttype double

class CPG_UserParameters : public ControlParameters {
public:
    CPG_UserParameters()
...
#endif //BLACKPANTHER_CPG_USERPARAMETERS_H
